...
extern int MACSIO_WORK_DoComputeWork(double *currentDt, double targetDelta, int workIntensity);
extern int MACSIO_WORK_LevelOne(double *currentDt, double targetDelta);
