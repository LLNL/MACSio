...
#define MACSIO_TIMING_INNER_TIMER (~((MACSIO_TIMING_TimerId_t)0x0))
#define MACSIO_TIMING_INVALID_TIMER MACSIO_TIMING_INNER_TIMER
...
#ifdef HAVE_MPI
extern void                      MACSIO_TIMING_ReduceTimers(MPI_Comm comm, int root, MACSIO_TIMING_GroupMask_t gmask);
#else
extern void                      MACSIO_TIMING_ReduceTimers(int comm, int root, MACSIO_TIMING_GroupMask_t gmask);
#endif
extern void                      MACSIO_TIMING_DumpReducedTimersToStrings(char ***strs, int *nstrs, int *maxlen);
