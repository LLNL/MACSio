...
static const char* json_extarr_type_name[] = {
  /* If you change this, be sure to update the enum json_extarr_type definition too */
  "null",
  "bit01",
  "byt08",
  "int32",
...
{
	int o_type_int = (int)o_type;
	if (o_type_int < 0 || o_type_int >= (int)NELEM(json_extarr_type_name))
	{
		MC_ERROR("json_extarr_type_to_name: type %d is out of range [0,%d]\n", o_type, NELEM(json_extarr_type_name));
		return NULL;
	}
	return json_extarr_type_name[o_type];
}
...
int json_extarr_type_nbits(enum json_extarr_type o_type)
{
    switch (o_type)
    {
        ...
        case json_extarr_type_byt08: return 8;
        case json_extarr_type_int32: return 32;
        case json_extarr_type_int64: return 64;
        case json_extarr_type_flt32: return 32;
        case json_extarr_type_flt64: return 64;
    }
    return -1;
}
...
{
    int nbits = json_extarr_type_nbits(o_type);
    if (nbits <= 0) return -1;
    return nbits / 8;
}
